...
- **The maker network** — the community feed, the marketplace and a shared widget
  library, as those features roll out.
- **XP and rewards** as you build, share and publish.
...
A free account is the on-ramp from *building alone* to *building with others*:
follow makers, fork dashboards, publish widgets, and — soon — subscribe to audited
strategy signals. You opt into as much of the network as you want, one step at a
time.

[Create your free account](https://app.nexow.ai) — or keep building locally. Both
