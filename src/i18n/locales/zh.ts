...
export const zh: SiteContent = {
  ...
  home: {
    ...
    automate: {
      ...
      items: [
        ...
        },
        {
          icon: 'cpu',
          title: '智能体',
          body: 'AI 智能体配备完整框架——模型、记忆、技能、工具、知识和触发器。交给智能体一项任务，让它监视、推理并行动——今天就能在可视化框架构建器中设计你的智能体；云端部署即将推出。',
          status: 'soon',
        },
        {
          icon: 'chat',
          title: 'Copilot',
          body: '面向整个工作区的 AI 助手。附上某个组件的截图或它的实时数据然后提问——“解释这张图”、“总结一下”、“我接下来该关注什么？”',
          status: 'soon',
        },
      ],
    ...
    network: {
      ...
      items: [
        ...
        },
        {
          icon: 'store',
          title: '市场',
          body: '组件分享已在社区上线——接下来是一个市场，用于买卖现成组件，并从你的作品中获得收益。',
          status: 'soon',
        },
        {
          icon: 'signal',
        ...
        },
        {
          icon: 'trophy',
          title: 'XP 与奖励',
          body: '一个游戏化的账户——每个组件、机器人和分享都能赚取 XP。升级、解锁成就徽章，并把它们兑换成奖励积分。',
          status: 'soon',
        },
      ],
      accountBadge: '免费账户',
    ...
    roadmap: {
      ...
      title: '这是预览版。接下来是这些。',
      subtitle:
        'Nexow 已发布画布、代码生成、云端机器人、账户和社区信息流的公开预览。下面这些基础模块即将落地。',
      shipped: '已发布',
      soon: '即将推出',
      items: [
        ...
        { status: 'soon', title: '智能体与 Copilot', body: '部署配备完整框架的云端智能体，以及面向你工作区的 Copilot。' },
        { status: 'soon', title: '市场与信号', body: '买卖组件，并发布你可以从中获益的经审计策略信号。' },
        { status: 'soon', title: 'XP、徽章与奖励', body: '一个游戏化的账户——凭成就赚取 XP 和徽章，并把它们兑换成奖励积分。' },
      ],
    },
    faq: {
      eyebrow: '常见问题',
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: 'cpu', title: 'AI 智能体', body: '配备完整框架的智能体——模型、记忆、技能、工具、知识和触发器。今天就能在可视化框架构建器中设计你的智能体——云端部署即将推出。' },
          { icon: 'chat', title: 'Copilot', body: '面向你工作区的助手：附上某个组件的截图或数据，让它解释、总结或建议你接下来该关注什么。即将推出。' },
        ],
      },
      {
        title: '网络',
        ...
        items: [
          ...
          { icon: 'store', title: '市场', body: '买卖现成组件，并从你的作品中获得收益。即将推出——分享功能已在社区中运作。' },
          { icon: 'signal', title: '策略信号', body: '发布经审计的业绩记录，订阅你信任的信号，并从你运行的策略中获得收益。即将推出。' },
          { icon: 'trophy', title: 'XP 与奖励', body: '通过构建赚取 XP，凭成就解锁徽章，并把它们兑换成奖励积分。即将推出。' },
        ],
      },
      {
        title: '掌控',
