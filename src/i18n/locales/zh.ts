...
export const zh: SiteContent = {
  ...
  plansPage: {
    ...
    faq: [
      ...
      { q: '我的声望是怎么算的？', a: '在你的设备上，根据你自己的活动计算。每条帖子 5 分，一个小组件 5 分，一个看板 10 分，一个机器人 15 分，一个发布的资源 25 分，一次安装 10 分，一个粉丝 3 分——再加上每个徽章档位 20 分、每枚稀有勋章 100 分、每枚传奇勋章 250 分。之上还有五个等级：青铜、250 分的白银、1,000 分的黄金、5,000 分的铂金和 20,000 分的传奇。' },
      { q: '徽章和方案有关吗？', a: '没有。全部 34 枚徽章、五个等级和整个社区层都在 Free 里。方案买的是容量和外观，从不买身份——免费账号一样能冲到传奇。把这些成就换成积分和 NEXO 代币，会随 Nexow DAO 一起上线。' },
    ],
  },
  rewards: {
    eyebrow: '声望与奖励',
