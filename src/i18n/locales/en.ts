...
export const en: SiteContent = {
  nav: {
    ...
    tourTrackHint: 'Change Me',
    tourLeft: 'Time left',
    tourControls: 'Tour controls',
    tourPace: 'Scroll speed',
    tourPaceHint: 'Go Faster',
  ...
  home: {
    ...
    acts: {
      ...
      connectors: {
        ...
        body: 'Finance, wallets, services, socials, databases and APIs. Where the venue allows it your browser talks to them directly, so there is nothing to configure by hand.',
        beats: [
  ...
  rewards: {
    ...
    ledger: {
      ...
      totalBody: 'Every badge tier and medal — the free credits the app pays today, claimed once. NXW and level-up bonuses stay planned with the DAO.',
