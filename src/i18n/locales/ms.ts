...
export const ms = {
  nav: {
    ...
    tourPlay: 'Mainkan lawatan',
    tourStop: 'Hentikan lawatan',
    tourTrack: 'Main lagu lain',
    tourLeft: 'Masa berbaki',
    tourControls: 'Kawalan lawatan',
    switchLang: 'Tukar bahasa',
    primaryNav: 'Utama',
    mobileNav: 'Mudah alih',
  ...
  home: {
    ...
    stats: [
      ...
      { n: 100, suffix: 'K', label: 'kredit AI percuma yang dikhaskan semasa mendaftar' },
    ...
    roadmap: {
      ...
      items: [
        ...
        { status: 'soon', title: 'Pelan berbayar & kredit ganjaran', body: 'Pembayaran Lite dan Elite, kredit platform, dan menukar reputasi menjadi kredit ganjaran.' },
      ],
    },
    faq: {
      ...
      items: [
        ...
        {
          q: "Berapa kosnya?",
          a: "Free merangkumi kanvas widget penuh, perpustakaan, sync awan, 10 bot, 3 ejen, akses komuniti dan 100,000 kredit AI semasa daftar. Lite dan Elite menambah kredit bulanan, kuota automasi lebih tinggi dan rupa premium — pembayaran akan datang tidak lama lagi. Lihat Pelan untuk perbandingan penuh.",
        },
      ],
    },
    cta: {
  ...
  plansPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Lite dan Elite ditakrifkan dan dipaparkan dalam apl, tetapi pembayaran berbayar akan datang tidak lama lagi. Semua orang pada Free hari ini — buat akaun untuk berada di hadapan apabila bil dibuka.",
      },
      {
        q: "Bolehkah saya bayar tahunan?",
        a: "Ya. Bil tahunan memberi anda dua bulan percuma berbanding bulanan — $99.90 setahun untuk Lite, $699.90 untuk Elite. Anda boleh tukar antara bulanan dan tahunan bila-bila masa.",
      },
      {
  ...
  waitlist: {
    ...
    subtitle: 'Pengebilan Lite dan Elite akan tiba tidak lama lagi. Tinggalkan e-mel anda dan kami akan memberitahu pada hari pembayaran dibuka — tiada spam.',
    placeholder: 'anda@email.com',
  ...
  rewards: {
    ...
    planned: 'Dirancang',
    plannedNote: 'Mata, lencana, tahap dan ganjaran kredit percuma sudah aktif dalam aplikasi hari ini. Pembayaran NXW dan bonus tahap tiba bersama Nexow DAO — NXW menjalani dry mint pada 14 Ogos 2026.',
    teaser: {
    ...
    badges: {
      ...
      how: {
        ...
        friends: 'Tambah kenalan bersama — orang yang anda ikuti dan mereka mengikuti anda kembali.',
      ...
      names: {
        ...
        penPal: 'Sahabat pena',
        greenLight: 'Lampu hijau',
        buildFlagger: 'Pelapor binaan',
        tagClose: 'Kawan',
        tagFamily: 'Keluarga',
        tagWork: 'Rakan sekerja',
        tagTeam: 'Rakan pasukan',
        tagSchool: 'Rakan sekelas',
        tagMentor: 'Mentor',
        tagFavorite: 'Kegemaran',
        oracle: 'Orakel',
        agora: 'Agora',
        catalyst: 'Pemangkin',
        foundry: 'Kilang',
    ...
    ledger: {
      ...
      rows: {
        ...
        gold: 'Peringkat emas',
        tagBronze: 'Kawan · bronze',
        tagSilver: 'Kawan · silver',
        tagGold: 'Kawan · gold',
        rare: 'Pingat jarang',
        tagRare: 'Kawan · rare',
      ...
      months: '= {n} bulan penjanaan bertaraf Elite, diperoleh',
      tokenomics: {
        eyebrow: 'NXW · Solana',
