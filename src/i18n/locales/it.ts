...
export const it: SiteContent = {
  ...
  rewards: {
    ...
    ledger: {
      ...
      tokenName: 'NXW',
      tokenNote: 'NXW è il token di governance della Nexow DAO. Il {pct} dell’offerta è riservato alla scala della community; chi lo detiene propone, vota e guida la tesoreria.',
      colUnlock: 'Sblocco',
