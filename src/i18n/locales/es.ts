...
export const es: SiteContent = {
  ...
  home: {
    ...
    hero: {
      ...
      titleGradient: 'Construye cualquier cosa',
      titleWatch: 'vigílalo todo.',
      titleTail: 'Actúa rápido, comparte - crece - gana',
